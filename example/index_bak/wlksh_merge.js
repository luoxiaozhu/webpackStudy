...
const earthCompChina = {
    ...
    config: {
        ...
        distMap: {
            '#ffc325': {
                name: '北部',
                camera: { x: -51.17, y: 134.61, z: -120.65 },
                target: { x: 0, y: 0, z: 0 }
            },
            '#25b9ff': {
                name: '西部',
                camera: { x: -0.77, y: 128.16, z: -164.45 },
                target: { x: 0, y: 0, z: 0 }
            },
            '#a864ff': {
                name: '中部',
                camera: { x: -58.88, y: 97.09, z: -124.96 },
                target: { x: 0, y: 0, z: 0 }
            },
            '#00ffcd': {
                name: '南部',
                camera: { x: -44.5, y: 68.96, z: -147.61 },
                target: { x: 0, y: 0, z: 0 }
            },
            '#fa9e9e': {
                name: '东部',
                camera: { x: -72.16, y: 81.21, z: -129.32 },
                target: { x: 0, y: 0, z: 0 }
            }
        }
    },
...
instance.init({
    render: {
        ...
        camera: {
            near: 2,
            position: { x: -89.8, y: 171.0, z: -211.1 }
        },
        controls: {
...
function hideOtherDistPoint(topObj, dist) {
    const objs = topObj.group.children[0].children;
    objs.forEach((obj) => {
